...
int main(void) {
    double data[MAX_ROWS][MAX_COLS];   // Array to store data from file
    char buffer[MAX_BUFFER_SIZE];      // Buffer for reading lines from file
    int rowIndex = 0;                   // Index for current row
    int colIndex = 0;                   // Index for current column
    char *ptr;                          // Pointer for string parsing
